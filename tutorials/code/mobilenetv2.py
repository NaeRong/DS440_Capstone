...
Original file is located at
    https://colab.research.google.com/drive/1--i8kWvQ9k5yQKcnF1iX4fxOb4xDdM4c
"""
...
parser.add_argument('--model-name', type=str, default='mobilenet_v2', metavar='M',
...
def test(model, test_loader, criterion=nn.CrossEntropyLoss()):
    ...
    model_name = 'mobilenet_%d_%d.pth' % (epoch, accuracy)
